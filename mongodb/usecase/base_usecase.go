...
func (u *baseUsecase) FindMany(ctx context.Context, filter bson.D, models any) {
...
func (u *baseUsecase) UpdateOne(ctx context.Context, filter bson.D, update bson.M) bool {
